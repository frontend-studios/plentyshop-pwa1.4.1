        ...
        <a :href="t('homepage.heroCTALinkTo')">
          ...
          <div class="heroline-wrapper absolute">
            <div class="bg-white p-3 mb-3">
              <span class="text-sm font-bold block text-primary-500" v-if="t('homepage.heroSubHeadline') != ''">{{ t('homepage.heroSubHeadline') }}</span>
              <span class="text-xl block text-primary-500" v-if="t('homepage.heroSubHeadline') != ''">{{ t('homepage.heroHeadline') }}</span>
            </div>
            <span class="btn btn-primary inline-block font-medium text-base py-2 px-4 text-white bg-primary-500 shadow hover:text-primary-500 hover:bg-white" v-if="t('homepage.heroCTABtnText') != ''">
        ...
        >
          <a :href="link">
            ...
            <div class="cat-wrapper absolute">
              <span class="btn btn-primary inline-block font-medium text-base py-2 px-4 text-white shadow bg-primary-500 hover:text-primary-500 hover:bg-white">{{ title }}</span>
            </div>
          </a>
        </div>
      </div>
